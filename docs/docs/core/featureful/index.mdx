...
- Simpler features will simply `put()` things in the environment that applications will then be able to request and consume. An example of such a feature is `tegral-logging`. <!-- TODO link -->

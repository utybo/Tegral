...
/**
 * Root configuration for Tegral appliactions. If you wish to create a custom configuration class, you must implement
 ...
 * ```
 *
 * Tegral application configurations, even custom ones, must contain a way to add `[tegral.*]` blocks as most
